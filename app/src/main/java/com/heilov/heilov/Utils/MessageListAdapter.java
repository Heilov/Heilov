...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getMessageUser().getUid().equals(currentUser.getUid())) {
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(ChatMessage message) {
            ...
            timeText.setText(DateFormat.format("dd-MM-yyyy (HH:mm:ss)",
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        ReceivedMessageHolder(View itemView) {
            super(itemView);
            Log.d("Heilov", "VIEW_TYPE_MESSAGE_SENT2");
            messageText = (TextView) itemView.findViewById(R.id.text_message_body);
            timeText = (TextView) itemView.findViewById(R.id.text_message_time);
        ...
        void bind(Context context, ChatMessage message) {
            messageText.setText(message.getMessageText());
            Log.d("Heilov", "VIEW_TYPE_MESSAGE_SENT1");
            // Format the stored timestamp into a readable String using method.
            timeText.setText(DateFormat.format("dd-MM-yyyy (HH:mm:ss)",
                    message.getMessageTime()));
            ...
            Glide.with(context).load(message.getMessageUser().getProfilePic()).into(profileImage);
