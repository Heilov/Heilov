...
public class EmailNotifier extends javax.mail.Authenticator implements Observer {
    ...
    public void setUserAndPas(String user, String password) {
    ...
    public void update(Context context, String message) {
        ...
        try {
            sendMail("Heilov updates", message, user, loggedUser.getEmail());
        } catch (Exception e) {
            Log.d("Heilov", e.toString());
        }
    }
